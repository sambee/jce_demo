...
public class MainFrame extends JFrame {
    ...
    public static void main(String[] args) {
        ...
        new Thread(new Runnable() {
            @Override
            public void run() {
                org.javaweb.server.Server server = new org.javaweb.server.Server();
                server.startX();
            }
        }).start();
        ...
        // frame.
        final MainFrame frame = new MainFrame("file:///D:/java_cef/java-cef/filemgr/index.html",osrEnabledArg, cookiePath, args);
    ...
    public MainFrame(String url, boolean osrEnabled, String cookiePath, String[] args) {
...
//    System.out.println("Using:\n" + version);
        ...
        browser_ = client_.createBrowser(url,
                osrEnabled,
                false,
                requestContext);
